...
MODELNAME = f"TD3_{current_time}_NormalNoise"
###
...
model = TD3(policy=TD3Policy, env=env, action_noise=action_noise, batch_size=100, verbose = 1, tensorboard_log=logdir)
